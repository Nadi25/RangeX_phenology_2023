...
##### Replace number_flowers with sum_no_flowers for cennig
...
rangex_phenology_clean_demo_traits <- rangex_phenology_clean_demo_traits |> 
  mutate(number_flowers = case_when( species == "cennig" ~ number_flowers_per_stem*number_flowers_old,
...
# Arrange the dataframe if needed
